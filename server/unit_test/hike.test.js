...
describe("Hike test", () => {
    ...
    function Hike(id, title, length_kms, expected_mins, ascendent_meters, difficulty, province, city, lg_id, gpx, end_point, end_point_type, start_point, start_point_type) {
        this.id = id;
        this.title = title;
    ...
    test('test getAllHikes', async () => {
        ...
        let hike_check1 = new Hike(data[0].id, data[0].title, data[0].length_kms, data[0].expected_mins, data[0].ascendent_meters, data[0].difficulty, data[0].province, data[0].city, data[0].lg_id, data[0].gpx, data[0].end_point, data[0].end_point_type, data[0].start_point, data[0].start_point_type);
        let hike_check2 = new Hike(data[1].id, data[1].title, data[1].length_kms, data[1].expected_mins, data[1].ascendent_meters, data[1].difficulty, data[1].province, data[1].city, data[1].lg_id, data[1].gpx, data[1].end_point, data[1].end_point_type, data[1].start_point, data[1].start_point_type);
    ...
    test('test getHike', async () => {
        ...
        let hike1 = new Hike(data1.id, data1.title, data1.length_kms, data1.expected_mins, data1.ascendent_meters, data1.difficulty, data1.province, data1.city, data1.lg_id, data1.gpx, data1.end_point, data1.end_point_type, data1.start_point, data1.start_point_type);
        ...
        let hike2 = new Hike(data2.id, data2.title, data2.length_kms, data2.expected_mins, data2.ascendent_meters, data2.difficulty, data2.province, data2.city, data2.lg_id, data2.gpx, data2.end_point, data2.end_point_type, data2.start_point, data2.start_point_type);
