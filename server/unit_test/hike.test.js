...
describe("Hike test", () => {
    ...
    test('test getAllHikes', async () => {
        ...
        let hike1 = new Hike(1, 'ROCCIAMELONE', 9, 420, 3538, 'Professional Hiker', '', 'Piemonte', 'TO', 'Montepantero', 1, 'gpx_content', 1, 'general point', 2, 'Parking point');
        let hike2 = new Hike(2, 'Salita al Monte Antoroto', 17, 444, 400, 'Professional Hiker', '', 'Piemonte', 'CN', 'Garessio', 1, 'gpx_content', 1, 'Parking point', 3, 'Parking point');
    ...
    test('test getHike', async () => {
        ...
        let hike_check1 = new Hike(1, 'ROCCIAMELONE', 9, 420, 3538, 'Professional Hiker', '', 'Piemonte', 'TO', 'Montepantero', 1, 'gpx_content', 1, 'general point', 2, 'Parking point');
        expect(hike_check1).toEqual(hike1);
        ...
        let hike_check2 = new Hike(2, 'Salita al Monte Antoroto', 17, 444, 400, 'Professional Hiker', '', 'Piemonte', 'CN', 'Garessio', 1, 'gpx_content', 1, 'Parking point', 3, 'Parking point');
        expect(hike_check2).toEqual(hike2);
