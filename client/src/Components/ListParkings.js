                ...
                <Row className="m-3" style={{ margin: 0, padding: 0 }}>
                    {
                        user.role !== 'local guide'
                            ...
                            <>
                                <Row style={{ height: 30 }}></Row>
                                <Button as={Col} xs={12} sm={12} md={2} lg={2} xl={2} xxl={2} type="submit" variant="outline-success" className="styleButton"  onClick={() => navigate("/new-parking")}>New Parking Lot</Button>
                            </>
                    }
                </Row>
                <ListGroup>
